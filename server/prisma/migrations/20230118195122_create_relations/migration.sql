...
CREATE TABLE "new_habit_sweek_day" (
...
INSERT INTO "new_habit_sweek_day" ("habit_id", "id", "week_day") SELECT "habit_id", "id", "week_day" FROM "habit_sweek_day";
DROP TABLE "habit_sweek_day";
ALTER TABLE "new_habit_sweek_day" RENAME TO "habit_sweek_day";
